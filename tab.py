...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.ClearLogBtn = QtWidgets.QPushButton(self.frame_7)
        self.ClearLogBtn.setObjectName("ClearLogBtn")
        self.horizontalLayout.addWidget(self.ClearLogBtn)
        ...
        Form.setTabOrder(self.yaoji, self.ClearLogBtn)
        Form.setTabOrder(self.ClearLogBtn, self.yuanshi)
